...
var setPointerPosition = function (pointerRadius, progress, gauge) {
    ...
    var pointers = (_a = {},
        ...
        _a[Pointer_1.PointerType.Arrow] = function () {
            var _a = (0, arc_1.getCoordByValue)(value, gauge, "inner", 0, 0.75), x = _a.x, y = _a.y;
            x -= 1;
            y += pointerRadius;
...
var calculatePointerPath = function (gauge, percent) {
    ...
    var endAngle = utils.degToRad(gauge.props.type == GaugeComponentProps_1.GaugeType.Semicircle ? 180 : 222);
